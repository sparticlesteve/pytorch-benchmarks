...
https://github.com/pytorch/pytorch/blob/v1.1.0/torch/nn/parallel/distributed_cpu.py
in order to compare the original DDP-CPU with the newer DDP in newer pytorch versions.
"""
